<%@ Page Language="C#" AutoEventWireup="true"
    CodeBehind="AddBilling.aspx.cs"
    Inherits="ElectricityBill.AddBilling" %>
...
<div class="header">
    ...
    <div>
        <a href="ShowingTheBill.aspx">View Bills</a>
...
<div class="card">
    ...
    <asp:TextBox ID="txtConsumerNumber" runat="server"
        Placeholder="Consumer Number (EB12345)"></asp:TextBox>
    ...
    <asp:TextBox ID="txtUnitsConsumed" runat="server"
        Placeholder="Units Consumed"></asp:TextBox>

    <asp:Button ID="btnAddBill" runat="server"
        Text="Generate Bill" OnClick="btnAddBill_Click" />
